...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/myimages/images/documents_files_128px_11652_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionnew_N->setIcon(icon);
        actionopen_O = new QAction(MainWindow);
        actionopen_O->setObjectName(QStringLiteral("actionopen_O"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/myimages/images/open_512px_1142209_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionopen_O->setIcon(icon1);
        actionclose_C = new QAction(MainWindow);
        actionclose_C->setObjectName(QStringLiteral("actionclose_C"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/myimages/images/close_512px_1142186_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionclose_C->setIcon(icon2);
        actionsave_S = new QAction(MainWindow);
        actionsave_S->setObjectName(QStringLiteral("actionsave_S"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/myimages/images/Save_256px_1093707_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/myimages/images/document_save_32px_16893_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionsave_as_A->setIcon(icon4);
        actionexit_X = new QAction(MainWindow);
        actionexit_X->setObjectName(QStringLiteral("actionexit_X"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/myimages/images/exit_out_128px_10885_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/myimages/images/stock_undo_128px_43395_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionbackout_Z->setIcon(icon6);
        actioncopy_C = new QAction(MainWindow);
        actioncopy_C->setObjectName(QStringLiteral("actioncopy_C"));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/myimages/images/copy_256px_1139197_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actioncopy_C->setIcon(icon7);
        actioncut_X = new QAction(MainWindow);
        actioncut_X->setObjectName(QStringLiteral("actioncut_X"));
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/myimages/images/cut_edit_128px_16040_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actioncut_X->setIcon(icon8);
        actionpaste_V = new QAction(MainWindow);
        actionpaste_V->setObjectName(QStringLiteral("actionpaste_V"));
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/myimages/images/paste_512px_1175635_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionpaste_V->setIcon(icon9);
        actionfind_F = new QAction(MainWindow);
        actionfind_F->setObjectName(QStringLiteral("actionfind_F"));
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/myimages/images/Internet_Lookup_Folder_255px_1123089_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionfind_F->setIcon(icon10);
        actionimprint = new QAction(MainWindow);
        actionimprint->setObjectName(QStringLiteral("actionimprint"));
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/myimages/images/emblem_note_128px_15992_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionimprint->setIcon(icon11);
        ...
        menu_E->addAction(actionbackout_Z);
        menu_E->addSeparator();
        ...
        menu_H->addAction(actionimprint);
...
#endif // QT_NO_SHORTCUT
        actionimprint->setText(QApplication::translate("MainWindow", "imprint", nullptr));
