...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral("images/exit_out_128px_10885_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionexit_X->setIcon(icon4);
        actionbackout_Z = new QAction(MainWindow);
        actionbackout_Z->setObjectName(QStringLiteral("actionbackout_Z"));
        QIcon icon5;
        icon5.addFile(QStringLiteral("images/stock_undo_128px_43395_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionbackout_Z->setIcon(icon5);
        actioncopy_C = new QAction(MainWindow);
        actioncopy_C->setObjectName(QStringLiteral("actioncopy_C"));
        QIcon icon6;
        icon6.addFile(QStringLiteral("images/copy_256px_1139197_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actioncopy_C->setIcon(icon6);
        actioncut_X = new QAction(MainWindow);
        actioncut_X->setObjectName(QStringLiteral("actioncut_X"));
        QIcon icon7;
        icon7.addFile(QStringLiteral("images/cut_edit_128px_16040_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actioncut_X->setIcon(icon7);
        actionpaste_V = new QAction(MainWindow);
        actionpaste_V->setObjectName(QStringLiteral("actionpaste_V"));
        QIcon icon8;
        icon8.addFile(QStringLiteral("images/paste_512px_1175635_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionpaste_V->setIcon(icon8);
        actionfind_F = new QAction(MainWindow);
        actionfind_F->setObjectName(QStringLiteral("actionfind_F"));
        QIcon icon9;
        icon9.addFile(QStringLiteral("images/Internet_Lookup_Folder_255px_1123089_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionfind_F->setIcon(icon9);
        actionimprint_Z = new QAction(MainWindow);
        actionimprint_Z->setObjectName(QStringLiteral("actionimprint_Z"));
        QIcon icon10;
        icon10.addFile(QStringLiteral("images/emblem_note_128px_15992_easyicon.net.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionimprint_Z->setIcon(icon10);
